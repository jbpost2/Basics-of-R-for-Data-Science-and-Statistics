...
- Type `View(cars)` (note capital `V`), `plot(cars)`, and `hist(iris$Sepal.Length)` on separate lines
...
- Visit “RStudio >> Tools >> Global Options” and locate the following:
    ...
    Pane Layout, Rainbow parenthesis, Soft-wrap, Show margin (set to 80), Highlight selected line, Show whitespace characters
