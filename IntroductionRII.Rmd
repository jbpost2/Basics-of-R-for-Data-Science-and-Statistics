...
> - [Excel](https://github.com/jbpost2/DataScienceR/blob/master/datasets/censusEd.xls) data  
...
- Once 'installed' on computer, never need to install again  
...
umpData<-read_delim("https://raw.githubusercontent.com/
                    jbpost2/DataScienceR/master/datasets/umps2012.txt",delim=">",
### <b>
...
- Download [censusEd.xls](https://github.com/jbpost2/DataScienceR/blob/master/datasets/censusEd.xls?raw=true)
