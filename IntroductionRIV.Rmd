...
## Activity 
- [**Numerical Summaries Activity** instructions](http://www4.stat.ncsu.edu/~post/DataScienceR/NumericalActivity.html) available on web  
...
## Activity 
- [**Basic Plotting Activity** instructions](http://www4.stat.ncsu.edu/~post/DataScienceR/BasicPlotActivity.html) available on web  
...
## Activity 
- [**ggplot Activity** instructions](http://www4.stat.ncsu.edu/~post/DataScienceR/ggplotActivity.html) available on web  
